#!/usr/bin/env python
# -*- coding: utf-8 -*
# https://github.com/zslwyuan/google-ngrams
...
def runQuery(argumentString):
    ...
    corpus, startYear, endYear, smoothing = 'eng_gb_2019', 2010, 2019, 3
...
if __name__ == '__main__':
    query = "bathroom, toilet, bathtub, toothbrush holder, toothpaste, shower curtain, toothbrush, towel rod, toilet paper, squeeze tube, faucet handle"
